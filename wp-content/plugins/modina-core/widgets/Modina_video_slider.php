...
class Modina_video_slider extends Widget_Base {

    public function get_name() {
        return 'modina_video_slider';
    }

    public function get_title() {
        return esc_html__( 'Hero - Video Slider', 'modina-core' );
    }
    ...
    public function get_keywords() {
        return [ 'fundbux', 'hero', 'slider', 'video', 'modina'];
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Video Slider - Hero', 'modina-core' ),
            ]
        );
        ...
        $repeater->add_control(
            'video_link', [
                'label' => esc_html__( 'Video Link - Youtube', 'modina-core' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => 'https://www.youtube.com/watch?v=E1xkXZs0cAQ',
            ]
        );
    ...
    <script>
        (function ( $ ) {
            ...
            $(document).ready( function() {
                ...
                if ($('.hero-slider-active.hero-3').length > 0) {
                    $(".hero-slider-active.hero-3").owlCarousel({        
                        items: 1,     
                        dots: false,
                        loop: true,
