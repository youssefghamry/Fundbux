        ...
        if ( $causes->have_posts() ) {
            while ( $causes->have_posts() ) { $causes->the_post(); 
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single-cause-item style-1 style-3">
                        <?php 
                        ...
                        <div class="cause-content">
                            ...
                            <div class="cause-amount mt-20  d-flex justify-content-between align-items-center">
                                <?php if ( $stats['raw_actual'] != 0 ) : ?>
                                <div class="chart" data-percent="<?php echo $bar_width; ?>">
                                    <span class="percent"></span>
                                </div>
                                <?php endif; ?>
                                <div class="right-info">
                                    <div class="total-raised">
                                        <i class="fal fa-money-check-alt"></i><span>$<?php echo $stats['raw_actual']; ?></span> <?php esc_html__( 'Raised', 'modina-core' ); ?>
                                    </div>
                                    <div class="price-goal">
                                        <i class="fal fa-analytics"></i><span><?php echo $stats['goal']; ?></span> <?php esc_html__( 'Goal', 'modina-core' ); ?>
                                    </div>
                                </div>
                                <div class="donate-btn">
                                    <a href="<?php the_permalink(); ?>"><?php echo esc_html__( 'Donate', 'modina-core' ); ?></a>
                                </div>
                            </div>
                        </div>
