...
<section class="blog-card-section blog-3 section-padding bg-cover" style="background-image: url('<?php echo esc_url($settings['section_bg']['url']); ?>')">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-blog-card card-2">
                    ...
                    <div class="blog-details">
                        ...
                        if ( ! empty( $categories ) ) {
                            echo '<a href="' . esc_url( get_category_link( $categories[0]->term_id ) ) . '" class="cat-name">' . esc_html( $categories[0]->name ) . '</a>';
                        }
                        ?>
