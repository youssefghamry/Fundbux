 ...
 * @see WP_Widget
 */
class Modina_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'recent_post_wid',
			'description' => esc_html__( 'Your Site&#8217;s Most Recent Posts.', 'modina-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'recent-posts', esc_html__( '(FundBux) Recent Posts', 'modina-core' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'News Feeds', 'modina-core' );
		...
		foreach ( $r->posts as $recent_post ) : ?>
            ...
            <div class="single-recent-post">
                ...
                <div class="post-data">
                    ...
                    <span><i class="fal fa-calendar-alt"></i><?php echo get_the_date( get_option('date_format'), $recent_post->ID ); ?></span>
                    <?php endif; ?>
                    <h5><a href="<?php the_permalink( $recent_post->ID ); ?>"><?php modina_core_limit_latter($title, 44, ''); ?></a></h5>
                </div>
            </div>
